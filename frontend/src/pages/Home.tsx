    ...
    <div className="max-w-3xl mx-auto">
      ...
      <div className="bg-white p-6 rounded-lg shadow mb-8">
        <h2 className="text-xl font-semibold text-gray-800 mb-4">
          Welcome to Leveraged LP with Gnosis Pay
        </h2>
        <p className="mb-4 text-gray-700">
          This application allows you to create a leveraged liquidity position using Aave V3 and
          Uniswap V4, all managed through your secure Gnosis Pay wallet.
        </p>
        ...
        {!isConnected ? (
          <div className="bg-gray-50 p-6 rounded-md border border-gray-200 text-center">
            ...
            <p className="mb-4 text-gray-600">
              To get started, connect your Gnosis Pay wallet. If you don't have one yet, you'll be
      ...
      <div className="bg-white p-6 rounded-lg shadow">
        ...
        <ul className="list-disc pl-5 space-y-2 mb-4 text-gray-700">
          <li>
            <span className="font-medium text-blue-700">Gnosis Pay:</span> Secure wallet management
            and transaction signing
          </li>
          <li>
            <span className="font-medium text-purple-700">Aave V3:</span> Lending protocol for ETH
            collateral and USDC borrowing
          </li>
          <li>
            <span className="font-medium text-pink-700">Uniswap V4:</span> Liquidity provision with
            automated fee collection
          </li>
          <li>
            <span className="font-medium text-green-700">Base Chain:</span> Fast, low-cost Ethereum
            L2 for all transactions
          </li>
        </ul>
      </div>
    </div>
